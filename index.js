...
function counterMakerWithLimit(num) {
  ...
  return function counter(){
    // if this condition is met, execute this line of code
...
const counter = counterMakerWithLimit(3)
  console.log(counter()); // should return 0
  console.log(counter()); // should return 1
  console.log(counter()); // should return 2
  console.log(counter()); // should return 3
  console.log(counter()); // should return 0
  console.log(counter()); // should return 1
  console.log(counter()); // should return 2
  console.log(counter()); // should return 3
